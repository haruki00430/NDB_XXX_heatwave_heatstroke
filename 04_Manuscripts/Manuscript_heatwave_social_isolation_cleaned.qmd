...
Heat-related illness is an increasingly urgent public health challenge in Japan. In 2023, heatstroke caused 1,580 deaths nationwide, and emergency ambulance transports for suspected heatstroke reached 91,467 cases, marking a 20% increase from the previous year.1), 2) The combination of accelerating climate change, population aging, and urbanization has elevated Japan's heat vulnerability, with projections indicating that heatwave frequency and intensity will continue to increase under current greenhouse gas emission scenarios.3) The economic burden of heat-related hospitalizations has been estimated to exceed 10 billion yen annually, and this cost is escalating as extreme heat events become more frequent.4)

Climatic factors such as ambient temperature, relative humidity, and wet-bulb globe temperature (WBGT) are well-established proximal determinants of heatstroke incidence.3), 4) The Japan Meteorological Agency has developed a nationwide WBGT forecasting system, and the Ministry of the Environment has implemented a multi-tier heat alert system to warn the public of dangerous heat conditions.5), 6) However, heat exposure alone does not fully explain geographic variation in heat-related morbidity. Within the same climatic zone, certain populations experience disproportionately higher heatstroke risk, suggesting that social determinants of heat vulnerability play a critical role at the community level.7), 8)

Older adults are particularly vulnerable to heat-related illness due to age-related physiological changes, including reduced sweating capacity, diminished thirst perception, impaired thermoregulatory reflexes, and chronic comorbidities such as cardiovascular disease and diabetes that compromise heat adaptation.9), 10) Among older adults, those living alone constitute an exceptionally high-risk subgroup. International evidence from the 2003 European heat wave, which caused approximately 70,000 excess deaths, identified social isolation as a major risk factor for heat-related mortality, with elderly individuals living alone experiencing 2- to 3-fold elevated mortality compared to those living with family.11), 12)

Multiple mechanisms may explain the elevated heat vulnerability of elderly solo households. First, economic barriers limit air conditioning use. Despite high air conditioning ownership rates in Japan (>90%), usage is constrained by electricity costs, particularly among low-income older adults reliant on public pensions.13), 14) Individuals living alone lack family members who might encourage air conditioning use or help cover utility costs. Second, social isolation reduces help-seeking behavior and delays recognition of heat illness symptoms. Older adults living alone may not have daily contact with others who could detect early warning signs of heat stress, such as confusion, dehydration, or reduced activity.15), 16) Third, limited access to heat-health information may reduce awareness of preventive measures. Public health communications about heat risk are often disseminated via television, internet, and mobile applications, yet older adults with low digital literacy and those without family support may not receive these messages.17)

Despite these theoretical considerations, no nationwide study has examined the association between elderly solo household rate and heat-related healthcare utilization using population-based administrative data. Previous studies in Japan have focused on individual-level risk factors (e.g., age, pre-existing disease, outdoor work) or examined specific municipalities,18), 19) but prefecture-level ecological analyses incorporating social vulnerability metrics have been lacking. The National Database (NDB) of Health Insurance Claims, released as open data by Japan's Ministry of Health, Labour and Welfare, provides a unique opportunity to assess heat-related infusion therapy utilization—a proxy for moderate-to-severe heat illness requiring medical intervention—across all 47 Japanese prefectures.
...
The strong association between elderly solo household rate and infusion therapy utilization is biologically and socially plausible, supported by convergent evidence from multiple disciplines. First, physiological vulnerability to heat stress increases markedly with age due to reduced sweating capacity, diminished thirst perception, impaired cardiovascular responses to heat, and chronic comorbidities such as diabetes and chronic kidney disease that compromise thermoregulation.9), 10), 22) Older adults exhibit blunted perception of thermal discomfort, reducing their likelihood of initiating protective behaviors such as air conditioning use or fluid intake until physiological decompensation has already occurred.26)

Second, economic barriers constrain air conditioning use among older adults living alone. Although air conditioning ownership exceeds 90% in Japan, usage is limited by electricity costs.13), 14) A national survey found that approximately 30% of older adults report reducing air conditioning use due to utility bill concerns, and this proportion is higher among those living alone who lack family members to share costs or encourage usage.23), 24) During the 2018 Japan heat wave, which resulted in 1,581 heatstroke deaths, post-event surveys revealed that many elderly decedents had air conditioning units but were not using them at the time of death.25)

Third, social isolation delays recognition and treatment of heat illness. Older adults living alone may not have daily contact with others who could detect early warning signs such as confusion, lethargy, or reduced oral intake.15), 16) In contrast, elderly individuals living with family members benefit from continuous informal monitoring, prompt hydration assistance, and earlier medical help-seeking.26) The 2003 European heat wave—which caused approximately 70,000 excess deaths—demonstrated that social isolation was the single most important modifiable risk factor for heat-related mortality, with risk ratios ranging from 2.0 to 3.5 for elderly individuals living alone compared to those living with family.11), 12), 27)

Fourth, limited access to heat-health information may reduce awareness among elderly solo households. Public health heat alerts in Japan are increasingly disseminated via digital platforms (websites, mobile apps, email), yet older adults with low digital literacy and those without family members to relay information may not receive timely warnings.17), 19), 30) Furthermore, heat-health messages often require health literacy to translate general warnings ("avoid outdoor activity") into specific actions ("drink 200 mL of water every 2 hours even if not thirsty"), and older adults living alone lack informal caregivers to facilitate this translation.28)

## 3. Comparison with Previous Studies

Our findings align with and extend international evidence on social determinants of heat vulnerability. The landmark Chicago heat wave of 1995, which caused 739 excess deaths over 5 days, identified social isolation as the strongest predictor of mortality, with spatial analysis revealing that neighborhoods with high proportions of elderly individuals living alone experienced the highest death rates.25), 29) Similarly, the 2003 European heat wave demonstrated that elderly individuals living alone had 2- to 3-fold elevated mortality across multiple countries, including France, Italy, and Spain.11), 12), 27)

In Japan, previous studies have examined individual-level risk factors for heatstroke, consistently identifying advanced age and pre-existing comorbidities as predictors.18), 26) However, most prior research has focused on emergency ambulance transport data or hospital admissions in specific municipalities, limiting generalizability.19), 27) To our knowledge, this is the first nationwide ecological study to quantify the association between elderly solo household rate and heat-related healthcare utilization using NDB administrative data. Our finding—that each one-percentage-point increase in elderly solo household rate is associated with approximately 723 additional infusion procedures per 100,000 population—provides a novel quantitative estimate relevant to policy planning and resource allocation.

Notably, our study found no significant association between climatic factors (heatwave days, WBGT) and infusion therapy utilization in univariate models. This counterintuitive finding may reflect several mechanisms. First, infusion therapy captures not only heat-related dehydration but also dehydration from other causes (gastroenteritis, chronic illness), introducing non-differential misclassification that may bias estimates toward the null. Second, prefecture-level climatic averages may not capture micro-scale heat exposure relevant to individual health outcomes, as urban heat islands, housing quality, and outdoor activity patterns vary substantially within prefectures.30), 28) Third, behavioral adaptation may attenuate the climate–health relationship: prefectures with historically high heat exposure may have developed cultural norms (e.g., afternoon rest periods, light clothing) that reduce heat illness risk despite high climatic exposure.25)

The stratified analysis revealed effect modification by aging rate, with stronger associations observed in low-aging prefectures. This pattern suggests that in communities with younger demographic profiles, elderly solo households constitute a more vulnerable minority who may lack the social infrastructure and community awareness available in "super-aged" prefectures where age-friendly services are more prevalent.29), 26) Future research should explore whether community-level aging rate moderates the effect of individual social isolation on heat vulnerability.

## 4. Policy Implications

Our findings have concrete policy implications in the context of Japan's national heat action plans and the ongoing escalation of heat-related morbidity. First, heat-health interventions should prioritize socially isolated older adults through targeted outreach. Japan's "Heat Illness Prevention Action Plan," launched by the Ministry of the Environment in 2022, includes heat alert systems and public awareness campaigns.5), 27) However, these interventions rely on mass communication channels that may not reach elderly solo households. Prefectures with high elderly solo household rates should implement proactive neighbor-checking programs ("Mimamori"), in which community health workers or volunteers conduct daily welfare checks during heat alerts.30), 28)

Second, social vulnerability indices—particularly elderly solo household rate—should be integrated into heat alert systems and resource allocation strategies. Currently, heat alerts are issued based solely on meteorological criteria (WBGT forecasts), without consideration of community-level social vulnerability.6) A geographically targeted alert system that prioritizes outreach to high-vulnerability prefectures could improve the efficiency and equity of heat-health interventions. The U.S. Centers for Disease Control and Prevention (CDC) has developed a Heat Vulnerability Index that incorporates social isolation metrics, providing a model for Japan to adapt.25)

Third, economic subsidies for air conditioning use among low-income elderly solo households should be expanded. Several Japanese municipalities have piloted utility bill subsidies or free air conditioning distribution programs for vulnerable older adults, but coverage remains limited and inconsistent across prefectures.29) Given the strong association between elderly solo household rate and heat-related healthcare utilization observed in this study, subsidizing air conditioning use in this population may be a cost-effective intervention to reduce heat-related morbidity and associated healthcare costs.

Fourth, heat-health information should be adapted for low-literacy populations and disseminated through channels accessible to elderly solo households. Current public health communications often assume internet access and high health literacy.17) Alternative dissemination strategies—including postal mail, fixed-line telephone hotlines, and television public service announcements—should be prioritized for reaching socially isolated older adults.26)
...
Sixth, the 2020 study period coincided with the COVID-19 pandemic, which may have altered healthcare-seeking behavior, outdoor activity patterns, and social contact among older adults. Emergency department visits declined nationwide during pandemic lockdowns, potentially reducing the capture of heat-related illness in administrative data.30) Finally, the use of 2014 air conditioning prevalence data as a covariate introduces temporal mismatch, although air conditioning ownership rates in Japan have been stable at >90% since 2010.14)
...
3) Parsons K. Heat stress standard ISO 7243 and its global application. Ind Health. 2006;44(3):368-379.
4) Blazejczyk K, Epstein Y, Jendritzky G, Staiger H, Tinz B. Comparison of UTCI to selected thermal indices. Int J Biometeorol. 2012;56(3):515-535.
5) Ministry of the Environment, Japan. Heat Illness Prevention Action Plan 2022. Tokyo: MOE; 2022.
6) Japan Meteorological Agency. WBGT forecasting and heat alert system. Available from: https://www.jma.go.jp/jma/index.html
7) Hondula DM, Balling RC, Andrade R, Krayenhoff ES, Middel A, Urban A, Georgescu M, Sailor DJ. Biometeorology for cities. Int J Biometeorol. 2017;61(Suppl 1):59-69.
8) Harlan SL, Declet-Barreto JH, Stefanov WL, Petitti DB. Neighborhood effects on heat deaths: social and environmental predictors of vulnerability in Maricopa County, Arizona. Environ Health Perspect. 2013;121(2):197-204.
9) Kenney WL, Munce TA. Invited review: aging and human temperature regulation. J Appl Physiol (1985). 2003;95(6):2598-2603.
10) Bouchama A, Knochel JP. Heat stroke. N Engl J Med. 2002;346(25):1978-1988.
11) Vandentorren S, Bretin P, Zeghnoun A, et al. August 2003 heat wave in France: risk factors for death of elderly people living at home. Eur J Public Health. 2006;16(6):583-591.
...
13) Ministry of Internal Affairs and Communications. National Survey of Family Income and Expenditure 2014. Tokyo: MIC; 2015.
14) Nakano M, Tanabe S. Thermal adaptation and comfort zones in urban high-rise apartments: field survey in Kanto region, Japan. Build Environ. 2020;181:107105.
15) Semenza JC, Rubin CH, Falter KH, et al. Heat-related deaths during the July 1995 heat wave in Chicago. N Engl J Med. 1996;335(84):84-90.
16) Naughton MP, Henderson A, Mirabelli MC, et al. Heat-related mortality during a 1999 heat wave in Chicago. Am J Prev Med. 2002;22(4):221-227.
17) Kondo MC. Health implications of redlining: heat islands. Curr Environ Health Rep. 2020;7(3):234-240.
18) Ng CF, Ueda K, Takeuchi A, et al. Sociogeographic variation in the effects of heat and cold on daily mortality in Japan. J Epidemiol. 2014;24(1):15-24.
19) Onozuka D, Hagihara A. Variation in vulnerability to extreme-temperature-related mortality in Japan: a 47-prefecture study. Environ Health. 2015;14:44.
20) Blazejczyk K. New indices to assess thermal risks outdoors. In: Matuschek O, ed. Environmental Ergonomics XI. Sweden: University of Lund; 2005:222-225.
21) Liljegren JC, Carhart RA, Lawday P, Tschopp S, Sharp R. Modeling the wet bulb globe temperature using standard meteorological measurements. J Occup Environ Hyg. 2008;5(10):645-655.
22) Larose TL, Bouchard DR, Sigal RJ, Boulé NG, Kenny GP. Age-related differences in body temperature regulation during exercise in the heat: a systematic review. J Sci Med Sport. 2015;18(5):595-601.
23) Consumer Affairs Agency, Government of Japan. Survey on electricity usage behavior among elderly households. Tokyo: CAA; 2019.
24) Sakka A, Santamouris M, Livada I, Nicol F, Wilson M. On the thermal performance of low income housing during heat waves. Energy Build. 2012;49:69-77.
25) National Police Agency. Report on heat-related deaths during 2018 summer heat wave. Tokyo: NPA; 2018.
26) Weisskopf MG, Anderson HA, Foldy S, et al. Heat wave morbidity and mortality, Milwaukee, Wis, 1999 vs 1995: an improved response? Am J Public Health. 2002;92(5):830-833.
27) Conti S, Meli P, Minelli G, et al. Epidemiologic study of mortality during the Summer 2003 heat wave in Italy. Environ Res. 2005;98(3):390-399.
28) Berkman ND, Sheridan SL, Donahue KE, Halpern DJ, Crotty K. Low health literacy and health outcomes: an updated systematic review. Ann Intern Med. 2011;155(2):97-107.
29) Semenza JC, Rubin CH, Falter KH, et al. Heat-related deaths during the July 1995 heat wave in Chicago. N Engl J Med. 1996;335(2):84-90.
30) Miyatake N, Sakano N, Murakami S. The relation between ambulance transports stratified by heat stroke and air temperature in all 47 prefectures of Japan in August, 2009: Ecological study. Environ Health Prev Med. 2012;17(1):77-80.
...
| Air conditioning prevalence (per 1%) | 31.23 (−24.18, 86.65) | 0.269 | 0.027 | 0.005 |
| Heatwave days (per 1 day) | −33.96 (−96.47, 28.55) | 0.287 | 0.025 | 0.003 |
| Mean WBGT (per 1°C) | 94.32 (−639.37, 828.01) | 0.802 | 0.001 | −0.021 |
...
| **Stratified: High aging rate (≥31.3%)** | 24 | 264.50 (−493.82, 1,022.82) | 0.458 | 0.025 | — |
